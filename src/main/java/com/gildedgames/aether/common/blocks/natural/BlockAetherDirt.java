...
public class BlockAetherDirt extends BlockCustom implements IBlockVariants
{
	...
	public static final BlockVariant DIRT = new BlockVariant(0, "dirt"), PERMAFROST = new BlockVariant(1, "permafrost"), COARSE_DIRT = new BlockVariant(2, "coarse_dirt");

	public static final PropertyVariant PROPERTY_VARIANT = PropertyVariant.create("variant", DIRT, PERMAFROST, COARSE_DIRT);
